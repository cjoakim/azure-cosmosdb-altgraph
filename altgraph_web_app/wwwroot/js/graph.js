$(document).ready(function () {
    ...
    (dataElement.dataset.nodesCsv == "" ? null : dataElement.dataset.nodesCsv)?.map(function (n) {
      console.log(n);
      nodes.push(n);
    });
    (dataElement.dataset.edgesCsv == "" ? null : dataElement.dataset.edgesCsv)?.map(function (e) {
      console.log(e);
      edges.push(e);
    });
    console.log("csv data should now be loaded");
