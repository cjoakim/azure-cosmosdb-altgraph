...
# Explore the size and shape of the IMDb TSV files.
...
cat .\imdb_raw\title.basics.tsv | Select-Object -first 3
cat .\imdb_raw\title.basics.tsv | Measure-Object -Line

echo ""
echo "title.principals.tsv"
cat .\imdb_raw\title.principals.tsv | Select-Object -first 3
cat .\imdb_raw\title.principals.tsv | Measure-Object -Line
