...
# Chris Joakim, Microsoft, April 2024

invoke-expression -Command .\build.ps1

# 1970 is the year, 90 minutes minimum

echo "========================"
echo "imdb_wrangle_raw_data..."
java -Xms1024m -Xmx2048m -jar build/libs/altgraph_data_app-2.0.0.jar imdb_wrangle_raw_data 1970 90 > out/imdb_wrangle_raw_data.txt
